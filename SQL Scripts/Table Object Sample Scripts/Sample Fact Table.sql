...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[YourFactTableName]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[YourFactTableName](
 ...
 CONSTRAINT [PK_YourFactTableName] PRIMARY KEY CLUSTERED 
(
	[RowID] ASC
