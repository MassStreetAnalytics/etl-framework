...
This script processes a CSV that was downloaded from a remote resource. The default is the file is downloaded with HTTP, however, other protocols can be used with minimal alteration.
